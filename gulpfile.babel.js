...
// Copies vendors js assets to dist
function vjs () {
...
function watchFiles (done) {
  ...
  gulp.watch('src/assets/js/vendor**/*.js', gulp.series(vjs, liveReload))
...
exports.development = gulp.series(
  cleanUp,
  gulp.parallel(html, copyAssets, copyStaticFiles, images, css, js, vjs),
  server, watchFiles
)
exports.build = gulp.series(
  cleanUp, stylelint, eslint,
  gulp.parallel(copyAssets, copyStaticFiles, images, html, css, js, vjs),
